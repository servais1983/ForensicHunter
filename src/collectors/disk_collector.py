...
class DiskCollector:
    ...
    def _collect_important_files(self, volume_id):
        ...
        important_paths = [
            ...
            fr"{volume_id}\Windows\System32\config\systemprofile\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup",
            
            # Fichiers utilisateur
            fr"{volume_id}\Users\*\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup",
            fr"{volume_id}\Users\*\AppData\Roaming\Microsoft\Windows\Recent",
            fr"{volume_id}\Users\*\AppData\Local\Temp",
